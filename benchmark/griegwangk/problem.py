...
from benchmark_problems import (joint_fitness_booth, joint_fitness_griegwangk,
                                joint_fitness_mtq, joint_fitness_oneridge)
...
# creator.create("Individual", list, fitness=creator.FitnessMin)  # Minimization
...
toolbox.register(
    ...
    creator.OutputMLC, limits=scen_enumLimits
)
