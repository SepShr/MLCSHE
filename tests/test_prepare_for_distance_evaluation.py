...
class Test_TestPrepareForDistanceEvaluation(unittest.TestCase):
    def test_prepare_for_distance_evaluation_testInput1(self):
        ...
        expected_nominal_values_indices = [0, 1, 3, 4, 6, 7, 8, 9, 10]

        self.assertEqual(prepare_for_distance_evaluation(test_list), \
